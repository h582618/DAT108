...
public class oppgave3 {
	...
	public static void main(String[] args) {
		...
		Ansatt a1 = new Ansatt("Geir", "Thomassen", "ÿkonom", Kjonn.MALE, 300000);
		...
		Boolean tjenerMerEnn≈tteK = listen.stream().anyMatch((a) -> a.getAarslonn() > 800000);

		System.out.println(tjenerMerEnn≈tteK);
